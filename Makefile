...
verify:
	swiftc Gosan/Models/Models.swift Gosan/Models/ProjectDocument.swift \
		Gosan/Audio/ProjectPackage.swift Gosan/Audio/ClipBuffer.swift Gosan/Audio/AudioExporter.swift \
		tools/AudioChecks.swift -o $(TMPDIR)gosan-audiochecks -framework AVFoundation
